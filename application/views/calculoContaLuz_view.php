...
<div class="container h-100">
  ...
  <div class="row h-100 align-items-center justify-content-center text-center">
    ...
    <div class="col-lg-8 align-self-baseline wow flipInX">
      ...
      <a class="btn btn-xl js-scroll-trigger" href="#calc" style="color: white !important; background-color: #ff5f2e;">Calcule o valor de sua Conta</a>
...
<h3 class="text-center wow fadeInUp" id="calc">Calcule o Valor de sua Conta</h3>
...
<form>
    ...
    <div class="row">
      ...
      <div class="col-md-6">
        ...
        <input id="kwh" type="tel" class="form-control" value="" onkeyup="num(this);" onblur="calcular()" placeholder="0">

      </div>

      <div class="col-md-6">

        <label >Insira o valor da tarifa em sua cidade:</label>

        <input id="tarifa" type="tel"  name="dinheiro"  class="form-control" value="" onkeyup="calcular()" placeholder="0.00">
