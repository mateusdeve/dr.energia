...
$(document).ready(function(){
  ...
  const consumoPonta = dados.map( dado => dado.consumoPonta );
  ...
  data: {
    ...
    datasets: [{
      ...
      pointHitRadius: 10,
      pointBorderWidth: 2,
      data: consumoPonta,//[dados[0].consumoPonta, dados[1].consumoPonta, dados[2].consumoPonta, dados[3].consumoPonta, dados[4].consumoPonta, dados[5].consumoPonta, dados[6].consumoPonta, dados[7].consumoPonta, dados[8].consumoPonta, dados[9].consumoPonta, dados[10].consumoPonta, dados[11].consumoPonta],
    }],
  },
  options: {
